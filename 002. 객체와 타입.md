...
## :speech_balloon:2-3. 익명 인터페이스 (anonymous interface)
...
## :speech_balloon:3-2. 접근 제한자 (access modifier)
...
## :speech_balloon:4-4. 전개 연산자 (spread operator)
